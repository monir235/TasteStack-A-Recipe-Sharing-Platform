...
const RecipeListPage = () => {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="relative bg-gradient-to-br from-violet-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center mb-12">
            <h1 className="text-5xl sm:text-6xl font-bold tracking-tight text-gray-900 dark:text-gray-100 mb-6">
              All <span className="bg-gradient-to-r from-violet-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">{t('recipes')}</span>
            </h1>
          ...
          <div className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-3xl p-6 border border-white/20 dark:border-gray-700/20 shadow-lg">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-6 text-center">{t('browse_by_category')}</h2>
                ...
                <button
                  ...
                  className={`group relative p-4 rounded-2xl transition-all duration-300 hover:scale-105 ${
                    selectedCategory === category.id
                      ...
                      : 'bg-white/80 dark:bg-gray-700/80 hover:bg-white dark:hover:bg-gray-600 text-gray-700 dark:text-gray-200 hover:shadow-md'
                  }`}
                >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-8">
          <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100">
            ...
            <span className="ml-2 text-lg font-normal text-gray-600 dark:text-gray-300">({filteredRecipes.length} recipes)</span>
          </h3>
        </div>
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {filteredRecipes.map((recipe) => (
            <Link key={recipe.id} to={`/recipes/${recipe.id}`} className="group block">
              <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-2xl border border-gray-100 dark:border-gray-700">
                <div className="relative overflow-hidden">
                  ...
                  <div className="h-56 bg-gradient-to-br from-violet-100 to-purple-100 dark:from-violet-800 dark:to-purple-800 flex items-center justify-center" style={{display: 'none'}}>
                    <div className="text-center">
                      ...
                      <span className="text-violet-400 dark:text-violet-500 font-medium">{t('recipe_image')}</span>
                    </div>
                  </div>
                  {/* Floating Badge */}
                ...
                <div className="p-6">
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100">{recipe.title}</h3>
                  <p className="mt-2 text-gray-600 dark:text-gray-300">{recipe.description?.substring(0, 100) || 'No description available'}...</p>
                  <div className="mt-4 flex items-center justify-between">
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="ml-1 text-sm text-gray-500 dark:text-gray-400">({recipe.average_rating})</span>
                    </div>
                  </div>
                  <div className="mt-4 flex items-center justify-between">
                    <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-violet-100 dark:bg-violet-800 text-violet-800 dark:text-violet-200">
                      {recipe.difficulty}
                    </span>
      ...
      {!loading && !error && filteredRecipes.length === 0 && recipes.length > 0 && (
        <div className="text-center py-12">
          ...
          <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">No recipes found</h3>
          <p className="text-gray-600 dark:text-gray-300 mb-4">No recipes match the selected category. Try a different category.</p>
          <button
      ...
      {!loading && !error && recipes.length === 0 && (
        <div className="text-center py-12">
          ...
          <h3 className="mt-2 text-sm font-medium text-gray-900 dark:text-gray-100">No recipes</h3>
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Get started by creating a new recipe.</p>
          <div className="mt-6">
            <a
              href="/create-recipe"
